 ...
 * progreso_api.php
 *
 * API para el cálculo y visualización del progreso de capacitaciones.
 *
 * Funcionalidad:
 *  - get_my_progress: Dashboard personal (Capacitaciones programadas vs Realizadas).
 *  - get_my_trainings: Lista detallada de historial de capacitaciones.
 *  - get_pending_trainings: Alertas de capacitaciones pendientes.
 *  - get_all_progress: Vista administrativa del avance de todos los colaboradores.
 *
 * Logica:
 *  - Cruza datos de `cap_programacion` (lo que debe hacer) vs `cap_formulario_asistente` (lo que hizo).
 *  - Las vistas SQL (v_progreso_capacitaciones) simplifican los cálculos complejos.
 */
