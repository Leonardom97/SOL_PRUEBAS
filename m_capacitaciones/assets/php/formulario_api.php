 ...
 * formulario_api.php
 *
 * API Principal para la gestión y creación de Formularios de Capacitación.
 *
 * Funcionalidad:
 *  - get_select: Obtiene opciones para listas desplegables (Whitelist estricta).
 *  - get_usuario / get_colaborador: Búsqueda de personas por cédula.
 *  - get_colaborador_relations: Recupera metadatos laborales (Cargo, Área, Empresa).
 *  - save_formulario: Creación transaccional de formularios y asistentes.
 *
 * Integraciones:
 *  - AuditLogger.
 *  - Actualización automática de notificaciones de capacitación.
 */
...
if ($action == 'get_select') {
    ...
    $logger->log(
        ...
        'CREATE_FORM',
        'Creación de formulario de capacitación',
        ['id_formulario' => $id_formulario, 'tema' => $data['tema']]
    );
