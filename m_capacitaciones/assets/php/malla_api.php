 ...
 * malla_api.php
 *
 * API para la generación de la Malla de Capacitaciones y Dashboard.
 *
 * Funcionalidad Principal:
 *  - Calculadora de cumplimiento de capacitación por colaborador.
 *  - Cruce de datos entre: Colaboradores activos, Cargos, Programación de Capacitaciones y Ejecuciones.
 *
 * Acciones:
 *  - get_malla: Retorna la matriz completa detallada por colaborador y tema.
 *  - get_summary: Resumen estadístico para el dashboard (Vencidas, Al día, Pendientes).
 *  - get_user_pending_trainings: Lista de capacitaciones pendientes para un usuario específico (Mi Perfil).
 *  - get_evaluation_dashboard_stats: Estadísticas de evaluaciones (Gráficos y KPIs).
 *
 * Logica de Negocio:
 *  - Determina si una capacitación está vencida, próxima a vencer o al día basándose en la última ejecución y la frecuencia configurada.
 */
