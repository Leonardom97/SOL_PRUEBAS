 ...
 * 
 * API de Consultas de Capacitaciones.
 * 
 * Genera un reporte detallado de todas las capacitaciones realizadas.
 * Incluye información cruzada de:
 * - Usuarios (Capacitador, Creador, Editor)
 * - Temas, Lugares, Procesos, Tipos de Actividad
 * - Estadísticas de asistentes (Aprobados, No Aprobados, Total)
 * 
 * Ruta: /m_capacitaciones/assets/php/consultas_capacitacion_api.php
 */
