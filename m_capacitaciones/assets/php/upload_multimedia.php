 ...
 *
 * API para la carga de archivos multimedia (Video, Imagen, PDF) en evaluaciones.
 *
 * Funcionalidad:
 *  - Validación de tipos de archivo permitidos (mp4, webm, pdf, jpg, png).
 *  - Límite de tamaño (300MB).
 *  - Eliminación de archivo previo si se está reemplazando.
 *  - Retorno de ruta relativa para almacenamiento en BD.
 *
 * Seguridad:
 *  - User Auth Required.
