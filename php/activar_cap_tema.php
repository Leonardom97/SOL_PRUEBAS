<?php
// php/activar_cap_tema.php
// Pone estado = 0 (activo) en cap_tema. NO toca nombre ni id.
...
try {
    ...
    // realizar UPDATE: fijar estado = 0
    ...
    api_log("activar_cap_tema error: ".$e->getMessage());
