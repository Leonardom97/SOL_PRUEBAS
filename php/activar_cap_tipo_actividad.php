<?php
// php/activar_cap_tipo_actividad.php
// Pone estado = 0 (activo) en cap_tipo_actividad. NO toca nombre ni id.
...
try {
    ...
    api_log("activar_cap_tipo_actividad error: ".$e->getMessage());
