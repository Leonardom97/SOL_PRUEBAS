<?php
// php/inactivar_cap_tipo_actividad.php
// Pone estado = 1 (inactivo) en cap_tipo_actividad. NO toca nombre ni id.
...
try {
    ...
    api_log("inactivar_cap_tipo_actividad error: ".$e->getMessage());
