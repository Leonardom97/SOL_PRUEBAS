 ...
 *
 * API para la gestión de Colaboradores (Empleados).
 *
 * Funcionalidad:
 *  - Listado con búsqueda global y paginación (GET).
 *  - Consulta de detalle por ID (GET).
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id']) && isset($_POST['nueva_contraseña'])) {
    ...
    if ($success) {
        $logger->log(
            ...
            'UPDATE_PASSWORD_COLABORADOR',
            'Cambio de contraseña a colaborador',
            ['id_colaborador' => $id]
        );
