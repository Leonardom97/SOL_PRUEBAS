	...
	d.fn.tableExport = function(k) {
					...
					b.each(function() {
						...
						d.each(G, function() {
							if (e > this.s.r && e <= this.e.r && l >= this.s.c && l <= this.e.c)
								for (h = 0; h <= this.e.c - this.s.c; ++h) n++, u++, f(null, e, l++)
						});
						if (c || a) a = a || 1, G.push({
							s: {
								r: e,
				...
				if (n[0].hasAttribute("data-tableexport-canvas")) var l = "";
					...
					d.each(b, function() {
						if (d(this).is("input")) l += n.find("input").eq(g++).val();
							...
							else if (void 0 === jQuery().bootstrapTable || !1 === d(this).hasClass("fht-cell") && !1 === d(this).hasClass("filterControl") && 0 === n.parents(".detail-view").length) l += d(this).html();
							if (d(this).is("a")) {
		...
		function N(b, c, d, q, f, h) {
			...
			if (e) try {
				if (Ea = new Blob([b], {
						type: d + ";charset=" + q
					}), saveAs(Ea, c, !1 === h), "function" === typeof a.onAfterSaveToFile) a.onAfterSaveToFile(b, c)
			} catch (l) {
				ka(c,
		...
		function ka(b, c, d) {
			...
			if (!1 !== b && window.navigator.msSaveOrOpenBlob) window.navigator.msSaveOrOpenBlob(new Blob([d]), b);
				...
				if (f) {
					...
					"object" === typeof d ? (window.URL = window.URL || window.webkitURL, e = [], e.push(d), h = window.URL.createObjectURL(new Blob(e, {
							type: c
		...
		if ("csv" === a.type || "tsv" === a.type || "txt" === a.type) {
			...
			d(r).each(function() {
				E(this, "th,td", p, r.length, function(b, c, d) {
					b = D(b, c, d) || ""; - 1 < b.indexOf(a.sql.columnEnclosure) && (b = W(b.toString(), a.sql.columnEnclosure, a.sql.columnEnclosure + a.sql.columnEnclosure));
					...
					d(a).each(function() {
						...
						E(this, "td,th", p, c + a.length, function(a, c, h) {
							if (null !== a) {
								...
								a = T(a);
								d.each(f, function() {
									if (p >= this.s.r && p <= this.e.r && e >= this.s.c && e <= this.e.c)
			...
			d(B).filter(function() {
				...
				for (var b = d(this), c = {}, e = this.getElementsByTagName("tr"), g = {
					...
					}, f = [], h, n = [], l = 0, u = 0, k, m, p, t, r, w = XLSX.SSF.get_table(); l < e.length && 1E7 > u; ++l)
						...
						for (k = m = 0; k < y.length; ++k)
							if (r = y[k], t = +J(r) || 1, h = k + z, !ta(d(r), B, h + (h < m ? m - h : 0))) {
								...
								if (null != h)
									...
									if ("s" === A) d(r).find("a").length && (h = "href" !== a.htmlHyperlink ? h : "", v = {
										f: '=HYPERLINK("' + d(r).find("a").attr("href") + (h.length ? '","' + h : "") + '")'
									});
