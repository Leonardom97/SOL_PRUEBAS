(function(){
  ...
  const COLUMNAS=[
    'coberturas_id','fecha','hora','fecha_actividad','responsable','contratista','codigo','colaborador','labor','plantacion','finca','siembra','lote','parcela','linea_entrada','linea_salida','unidad','cantidad','h_inicio','h_fin','cobertura','cant_colaboradores','operador','maquina','observaciones','supervision','error_registro'
  ];
  ...
  async function fetchData(){
    let last=''; for(const act of ACTIONS.listFallback){
      try{
        ...
        console.debug('[coberturas] request ->', `${API}?${qs.toString()}`);
