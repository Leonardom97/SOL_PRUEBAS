...
(function(){
  ...
  const COLUMNAS=[
    ...
    'finca','lote','parcela','linea','palma','contratista','codigo','colaborador','tipo_labor','racimos_optimos',
    'racimos_verdes','racimos_sobremaduro','racimos_enfermos','racimos_pedunculo_largo','palmas_hojas_mal_encalladas',
    'palmas_hojas_picadas','racimo_sin_cosechar','corte_estrella','palmas_sin_alistar','pepas_frescas_plato','pepas_frescas_fuera_plato',
    'nuevo_colaborador','supervision','error_registro'
  ];
