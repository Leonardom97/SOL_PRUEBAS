(function(){
  ...
  // ---------------------------------------------------------------
    ...
    const COLUMNAS=[
    'ct_cal_trampas_id','fecha','hora','responsable','colaborador','plantacion','finca','siembra','lote','parcela','trampa','plaga','hembra','macho','lado_a','lado_b','estado_lona','estado_trampa','estado_ubicacion','estado_ventana','estado_cania','estado_melaza','estado_feromona','calificación','observaciones','supervision','error_registro'
  ];
