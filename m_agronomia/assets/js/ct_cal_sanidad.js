 ...
 * ct_cal_sanidad.js
 * 
 * Módulo para: Control de calidad de sanidad
 * 
 * Funcionalidades principales:
 * - Listado paginado de registros de control de calidad de sanidad con filtros dinámicos
 ...
 * - Evaluación y seguimiento de la calidad sanitaria de los cultivos
...
(function () {
  ...
  const COLUMNAS = [
    'ct_cal_sanidad_id', 'fecha', 'hora', 'responsable', 'labor', 'colaborador', 'plantacion', 'finca', 'siembra', 'lote', 'parcela', 'linea',
    'palma', 'tipo_labor', 'estado', 'etapa', 'instar', 'verificacion', 'observaciones', 'supervision', 'error_registro'
  ];
