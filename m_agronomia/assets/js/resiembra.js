...
(function(){
  ...
  const COLUMNAS=[
    'resiembra_id','fecha','hora','fecha_actividad','colaborador','labor','contratista','plantacion','finca','siembra','lote','parcela','linea','palma','variedad_res','observacion_res','supervision','error_registro'
  ];
