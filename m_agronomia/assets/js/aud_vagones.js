(function(){
  ...
  const COLUMNAS=[
    'aud_vagones_id','hora','responsable','fecha_actividad','plantacion','contratista_vagon','tipo','numero_remision','racimos_verdes_vagon','racimos_sobremaduro_vagon','racimos_enfermos_vagon','racimos_tusas_vagon','racimos_pedunculo_largo_vagon','total_racimos','racimos_auditados','tipo_1','tipo_2','tipo_3','tipo_4','supervision','error_registro'
  ];
