...
(function(){
  ...
  const COLUMNAS=[
    'aud_mantenimiento_id','hora','responsable','labor_especifica','fecha_actividad','plantacion','siembra','finca','lote',
    'parcela','tipo_auditoria','linea_entrada','linea_salida','calificacion_m','linea_m','palma_m','observaciones','supervision',
    'error_registro'
  ];
