(function(){
  ...
  // ---------------------------------------------------------------
    ...
    const COLUMNAS=[
    'oficios_varios_palma_id','fecha','responsable','plantacion','finca','siembra','lote','parcela','labor_especifica','tipo_labor','contratista','codigo','colaborador','personas','hora_entrada','hora_salida','linea_entrada','linea_salida','cantidad','unidad','maquina','tractorista','nuevo_operario','error_registro','supervision'
  ];
