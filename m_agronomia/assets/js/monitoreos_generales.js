(function(){
  ...
  const COLUMNAS=[
    ...
    'parcela','linea','palma','grupo','estado','validacion','sintoma','observacion','error_registro','supervision'
  ];
  ...
  async function inactivar(id){
    ...
    try{
      ...
      const j=await r.json(); if(j.success){ console.log('[monitoreos_generales] inactivar ok', {id, result:j}); load(); }
      else {
