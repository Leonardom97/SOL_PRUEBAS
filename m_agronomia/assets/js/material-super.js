...
const TABS = [
  ...
  { key: "monitoreos-generales", label: "Monitoreos Generales", icon: "table", roles: ["aux_agronomico"] },
  { key: "ct-cal-sanidad", label: "Calidad Sanidad", icon: "leaf", roles: ["aux_agronomico"] },
  { key: "nivel-freatico", label: "Nivel Freático", icon: "water", roles: ["administrador", "supervisor_agronomico", "aux_agronomico"] },
  { key: "monitoreo-trampas", label: "Monitoreo Trampas", icon: "bug", roles: ["aux_agronomico"] },
  { key: "compactacion", label: "Compactación", icon: "compress", roles: ["administrador", "supervisor_agronomico", "aux_agronomico"] },
  { key: "plagas", label: "Plagas", icon: "skull-crossbones", roles: ["aux_agronomico"] },
  { key: "ct-cal-trampas", label: "Calidad Trampas", icon: "clipboard-list", roles: ["aux_agronomico"] },
  ...
  { key: "aud-maquinaria", label: "Auditoría Maquinaria", icon: "cogs", roles: ["administrador", "supervisor_agronomico", "aux_agronomico"] },
  ...
  { key: "compostaje", label: "Compostaje", icon: "recycle", roles: ["administrador", "supervisor_agronomico", "aux_agronomico"] },
  { key: "erradicaciones", label: "Erradicaciones", icon: "skull-crossbones", roles: ["administrador", "supervisor_agronomico", "aux_agronomico"] },
