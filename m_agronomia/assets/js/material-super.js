...
const TABS = [
  { key: "capacitaciones", label: "Recoleccion Fruta", icon: "chalkboard-teacher", roles: ["administrador", "supervisor_agronomico", "aux_agronomico", "asist_agronomico", "sup_logistica1"] },
  { key: "reuniones", label: "Mantenimientos", icon: "users", roles: ["administrador", "supervisor_agronomico", "aux_agronomico", "asist_agronomico", "sup_logistica1"] },
  { key: "asistencias", label: "Oficios Varios Palmas", icon: "clipboard-check", roles: ["administrador", "supervisor_agronomico", "aux_agronomico", "asist_agronomico", "sup_logistica1"] },
  { key: "ct-cal-labores", label: "Calidad Labores", icon: "tasks", roles: ["administrador", "supervisor_agronomico", "aux_agronomico", "asist_agronomico", "sup_logistica1"] },
  // Los demás tabs con solo admin/aux/supervisor (ahora incluye asist_agronomico)
