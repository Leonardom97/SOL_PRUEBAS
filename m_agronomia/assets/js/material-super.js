...
const TABS = [
  { key: "cosecha-fruta", label: "Cosecha Fruta", icon: "chalkboard-teacher", roles: ["administrador"] },
  ...
  { key: "reco-fruta", label: "Recoleccion Fruta", icon: "chalkboard-teacher", roles: ["administrador"] },
