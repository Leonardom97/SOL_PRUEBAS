(function(){
  ...
  // ---------------------------------------------------------------
    ...
    const COLUMNAS=[
    'reporte_lote_monitoreo_id','fecha','hora','colaborador','labor','plantacion','finca','siembra','lote','parcela','linea','palma','hallazgo','observacion','error_registro','supervision'
  ];
