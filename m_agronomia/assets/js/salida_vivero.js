...
(function(){
  ...
  const COLUMNAS=[
    'salida_vivero_id','fecha','hora','fecha_actividad','colaborador','labor','plantacion','finca','siembra','lote','parcela','variedad','cantidad','recibe','transporte','numero','observacion_vivero','supervision','error_registro'
  ];
