(function(){
  ...
  // ---------------------------------------------------------------
    ...
    const COLUMNAS=[
    'nivel_freatico_id','fecha','hora','colaborador','plantacion','finca','siembra','lote','parcela','linea','palma','n_pozo_observacion','superficie_tubo','profundidad_agua','verificacion','validacion','enterrado','nivel_freatico','error_registro','supervision'
  ];
