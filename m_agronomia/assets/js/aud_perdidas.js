...
(function(){
  ...
  const COLUMNAS=[
    'aud_perdidas_id','hora','responsable','tipo_auditoria','fecha_actividad','plantacion','siembra','finca','lote',
    'parcela','linea','palma','fruto_suelto_perdido','racimos_perdidos','supervision','error_registro'
  ];
