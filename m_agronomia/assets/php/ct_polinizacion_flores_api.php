<?php
/**
 * API ct_polinizacion_flores (adaptado a la lógica de mantenimientos).
 * Soporta: conexion(listar), upsert(actualizar), inactivar, activar, rechazar, aprobar.
 */
...
try {
    ...
    if ($action==='conexion') {
        ...
        $sql="SELECT * FROM ct_polinizacion_flores $whereSql $orderSql LIMIT :lim OFFSET :off";
        $stmt=$pg->prepare($sql);
        ...
        $sqlT="SELECT COUNT(*) FROM ct_polinizacion_flores $whereSql";
    ...
    if ($action==='actualizar') {
        ...
        $cols=[
            ...
            'flores_anteriores_sin_polinizar','flores_nuevas_sin_polinizar','aplicacion_2','aplicacion_3','labor','supervision','error_registro','check'
        ];
