...
try {
    ...
    if ($action==='inactivar'){
        ...
        try {
            ...
            $st=$pgMain->prepare("UPDATE cosecha_fruta SET error_registro='inactivo' WHERE cosecha_fruta_id=?");
            $st->execute([$id]);
        ...
        try {
            ...
            $stTemp=$pgTemp->prepare("UPDATE cosecha_fruta SET error_registro='inactivo' WHERE cosecha_fruta_id=?");
            $stTemp->execute([$id]);
