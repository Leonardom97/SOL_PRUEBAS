...
try {
    ...
    if ($action==='inactivar'){
        ...
        try {
            ...
            $st=$pgMain->prepare("UPDATE fertilizacion_organica SET error_registro='inactivo' WHERE fertilizacion_organica_id=?");
            $st->execute([$id]);
        ...
        try {
            ...
            $stTemp=$pgTemp->prepare("UPDATE fertilizacion_organica SET error_registro='inactivo' WHERE fertilizacion_organica_id=?");
            $stTemp->execute([$id]);
