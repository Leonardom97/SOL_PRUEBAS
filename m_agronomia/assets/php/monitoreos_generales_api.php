...
try {
    ...
    if ($action==='inactivar'){
        ...
        try {
            ...
            $st=$pgMain->prepare("UPDATE monitoreos_generales SET error_registro='inactivo' WHERE monitoreos_generales_id=?");
            $st->execute([$id]);
        ...
        try {
            ...
            $stTemp=$pgTemp->prepare("UPDATE monitoreos_generales SET error_registro='inactivo' WHERE monitoreos_generales_id=?");
            $stTemp->execute([$id]);
