...
try {
    ...
    if ($action==='actualizar') {
        ...
        $cols=[
            'siembra_nueva_id','id','fecha','hora','fecha_actividad','responsable','labor','plantacion',
            ...
            'cant_colaborador_siembra','operador','maquina','observacion','error_registro'
        ];
    ...
    if ($action==='inactivar'){
        ...
        $pg->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
        $st=$pg->prepare("UPDATE siembra_nueva SET error_registro='inactivo' WHERE siembra_nueva_id=?");
        $st->execute([$id]);
