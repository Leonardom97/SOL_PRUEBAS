 ...
 *
 * API para obtener operaciones pendientes de aprobación desde la base de datos temporal.
 * 
 * Propósito:
 * - Consulta registros con estado de supervisión 'pendiente' de una entidad específica.
 * - Utilizado por el sistema de notificaciones (campana) y los iconos de verificación.
 * 
 * Parámetros GET:
 * - entidad: Nombre de la tabla a consultar (ej: 'monitoreos_generales', 'cosecha_fruta')
 *            Por defecto: 'monitoreos_generales'
 * 
 * Respuesta JSON:
 * - datos: Array de registros pendientes
 * - total: Cantidad total de registros pendientes
 * - idCol: Nombre de la columna ID de la entidad
 * - columnas: Lista de todas las columnas de la tabla
 * 
 * Seguridad:
 * - Valida que el nombre de la entidad solo contenga caracteres alfanuméricos y guion bajo
 */
