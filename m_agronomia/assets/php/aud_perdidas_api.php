...
try {
    ...
    if ($action==='actualizar') {
        ...
        $cols=[
            'aud_perdidas_id','id','hora','responsable','tipo_auditoria','fecha_actividad','plantacion',
            'siembra','finca','lote','parcela','linea','palma','fruto_suelto_perdido','racimos_perdidos','error_registro'
        ];
