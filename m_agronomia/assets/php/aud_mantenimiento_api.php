...
try {
    ...
    if ($action==='actualizar') {
        ...
        $cols=[
            'aud_mantenimiento_id','id','hora','responsable','labor_especifica','fecha_actividad','plantacion',
            'siembra','finca','lote','parcela','tipo_auditoria','linea_entrada','linea_salida',
            'calificacion_m','linea_m','palma_m','observaciones','error_registro'
        ];
    ...
    if ($action==='inactivar'){
        ...
        $pg->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
        $st=$pg->prepare("UPDATE aud_mantenimiento SET error_registro='inactivo' WHERE aud_mantenimiento_id=?");
        $st->execute([$id]);
