...
try {
    ...
    if ($action==='inactivar'){
        ...
        try {
            ...
            $st=$pgMain->prepare("UPDATE aud_vagones SET error_registro='inactivo' WHERE aud_vagones_id=?");
            $st->execute([$id]);
        ...
        try {
            ...
            $stTemp=$pgTemp->prepare("UPDATE aud_vagones SET error_registro='inactivo' WHERE aud_vagones_id=?");
            $stTemp->execute([$id]);
