...
try {
    ...
    if ($action==='actualizar') {
        ...
        $cols=[
            ...
            'observacion_vivero','error_registro'
        ];
    ...
    if ($action==='inactivar'){
        ...
        try {
            ...
            $st=$pgMain->prepare("UPDATE salida_vivero SET error_registro='inactivo' WHERE salida_vivero_id=?");
            $st->execute([$id]);
        ...
        try {
            ...
            $stTemp=$pgTemp->prepare("UPDATE salida_vivero SET error_registro='inactivo' WHERE salida_vivero_id=?");
            $stTemp->execute([$id]);
