...
try {
    ...
    if ($action==='actualizar') {
        ...
        $cols=[
            'salida_vivero_id','id','fecha','hora','fecha_actividad','colaborador','labor','plantacion',
    ...
    if ($action==='inactivar'){
        ...
        $pg->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
        $st=$pg->prepare("UPDATE salida_vivero SET error_registro='inactivo' WHERE salida_vivero_id=?");
        $st->execute([$id]);
