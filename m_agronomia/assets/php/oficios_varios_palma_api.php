...
try {
    ...
    if ($action==='inactivar'){
        ...
        try {
            ...
            $st=$pgMain->prepare("UPDATE oficios_varios_palma SET error_registro='inactivo' WHERE oficios_varios_palma_id=?");
            $st->execute([$id]);
        ...
        try {
            ...
            $stTemp=$pgTemp->prepare("UPDATE oficios_varios_palma SET error_registro='inactivo' WHERE oficios_varios_palma_id=?");
            $stTemp->execute([$id]);
