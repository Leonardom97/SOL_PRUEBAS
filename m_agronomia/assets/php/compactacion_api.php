...
/**
 * API compactacion.
 * Acciones: conexion|listar|list, actualizar|upsert, aprobar|aprobar (admin),
 * rechazar|rechazar (admin), inactivar|inactivate.
 * Alias: approve->aprobar, reject->rechazar.
 *
 * Ajustes:
 * - Aceptar id genérico 'id' en upsert/inactivate/aprobar/rechazar.
