 ...
 * Alias entrada: approve->aprobar, reject->rechazar.
 *
 * Ajustes:
...
try{
  ...
  $table='ct_cal_labores'; $idCol='ct_cal_labores_id';
  $colsAllowed=[
    ...
    'tipo_validacion','grado_enfermedad','numero_galerias','promedio','estado','producto',
    'observacion','supervision','check','error_registro'
  ];
